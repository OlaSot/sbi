...
import ImageDecorationSectionClient from "./ImageDecorationSectionClient";

interface ImageDecorationSectionWrapperProps {
  params: { lang: string };
}

export default async function ImageDecorationSectionWrapper({
  params,
}: ImageDecorationSectionWrapperProps) {
